...
/*   Updated: 2025/04/23 12:55:49 by rbaticle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void) {
	...
	std::cout << std::endl;
	std::cout << "------EXO03-----" << std::endl << std::endl;

	DiamondTrap	xavier = DiamondTrap("Xavier");
	...
	xavier.attack(bertrand.getName());
	bertrand.takeDamage(xavier.getAttackDmg());
	xavier.beRepaired(2);
